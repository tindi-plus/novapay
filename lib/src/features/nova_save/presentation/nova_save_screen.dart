...
class NovaSaveScreen extends ConsumerWidget {
      ...
      body: SafeArea(
        child: CustomScrollView(
          ...
          slivers: [
            ...
            _buildActiveGoalsSliverSection(context, ref),
            const SliverToBoxAdapter(
              child: SizedBox(height: 80), // Extra bottom padding for FAB
            ),
          ],
        ),
      ),
  ...
  Widget _buildActiveGoalsSliverSection(BuildContext context, WidgetRef ref) {
    final goalsAsync = ref.watch(savingsGoalsStreamProvider);
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Semantics(
                label:
                    'Progress: ${goal.progressPercentage} of goal completed',
                readOnly: true,
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(8),
                  child: LinearProgressIndicator(
