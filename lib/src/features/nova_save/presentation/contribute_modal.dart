...
class _ContributeModalState extends ConsumerState<ContributeModal> {
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _buildSummaryRow(context, 'Goal', widget.goal.name),
                  const SizedBox(height: 12),
                  _buildSummaryRow(
                      context, 'Target Amount', widget.goal.formattedTargetNaira),
                  const SizedBox(height: 12),
                  _buildSummaryRow(
                    context,
                    'Target Date',
                  ...
                  Column(
                    ...
                    children: [
                      _buildSummaryRow(
                          context, 'Progress', widget.goal.progressPercentage),
                      const SizedBox(height: 8),
                      Semantics(
                        label:
                            'Progress: ${widget.goal.progressPercentage} completed',
                        readOnly: true,
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(4),
                          child: LinearProgressIndicator(
                            value: widget.goal.progressRatio,
                            minHeight: 8,
                          ),
                        ),
                      ),
  ...
  /// Helper widget that allows key-value label rows to wrap onto new lines when text scales
