...
//     final availableNaira = (currentUser.walletBalanceInKobo / 100).toStringAsFixed(2);
...
// /// Riverpod provider for SendMoneyForm state machine
// @riverpod
// class SendMoneyProvider extends _$SendMoneyProvider {
//   @override
...
// @riverpod
// Stream<List<PendingQueueItem>> watchPendingTransactions(Ref ref) {
...
// @riverpod
// Stream<List<LocalTransaction>> watchLocalTransactions(Ref ref) {
//   final database = ref.watch(databaseProvider);
...
// @riverpod
// Future<LocalTransaction?> getLocalTransactionById(Ref ref, String id) {
//   final database = ref.watch(databaseProvider);
